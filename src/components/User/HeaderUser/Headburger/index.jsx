      ...
      <Navbar fixed="top" bg="dark" variant="dark" className="py-0 vw-100">
        ...
        <HeadPanelStyled isOpen={isOpen}>
          <Container className="col">
            <Link onClick={headerRedirect('/sign-in')} className="btn btn-success mb-5 mt-5" to="/sign-in">
              <h3>Sign in</h3>
            </Link>
            <Link onClick={headerRedirect('/sign-up')} className="btn btn-primary mb-5" to="/sign-up">
              <h3>Sign up</h3>
            </Link>
